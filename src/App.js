...
function App() {
  ...
  const addToFavorites = (quoteId) => {
    ...
    if (alreadyFavorite) {
      ...
      setMessageText("Max number of quotes reached - please remove a favorite before adding a new one!");
      setShowMessage(true);
      // console.log("Max number of quotes reached - please remove a favorite before adding a new one.");
      }
    }
  };
